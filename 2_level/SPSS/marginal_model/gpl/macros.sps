...
APPLY DICTIONARY  from * /SOURCE VARIABLES = !repeatedmeasure /TARGET VARIABLES =repeatedmeasure_ /VARINFO FORMATS LEVEL VALLABELS = REPLACE.
APPLY DICTIONARY  from * /SOURCE VARIABLES = !subject /TARGET VARIABLES =subject_ /VARINFO FORMATS LEVEL VARLABEL VALLABELS = REPLACE.
...
APPLY DICTIONARY  from * /SOURCE VARIABLES = !group /TARGET VARIABLES =group_ /VARINFO FORMATS LEVEL VARLABEL VALLABELS = REPLACE.   
APPLY DICTIONARY  from * /SOURCE VARIABLES = !repeatedmeasure /TARGET VARIABLES =repeatedmeasure_ /VARINFO FORMATS LEVEL VARLABEL VALLABELS = REPLACE.
APPLY DICTIONARY  from * /SOURCE VARIABLES = !subject /TARGET VARIABLES =subject_ /VARINFO FORMATS LEVEL VARLABEL VALLABELS = REPLACE.
